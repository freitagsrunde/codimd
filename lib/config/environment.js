...
module.exports = {
  ...
  customCSSType: process.env.CMD_CUSTOM_CSS_TYPE,
  customCSSPath: process.env.CMD_CUSTOM_CSS_PATH,
  customCSSURL: process.env.CMD_CUSTOM_CSS_URL,
  customCSSData: process.env.CMD_CUSTOM_CSS_DATA,
